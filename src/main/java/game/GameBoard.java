...
public class GameBoard
{
    ...
    private void createGuiFields()
    {
        ...
        guiFields[1] = new GUI_Street("Rødovrevej", "kr. 1200", "", "2000", Color.BLUE, Color.BLACK);
        ...
        guiFields[5] = new GUI_Street("Rederiet Lindinger", "kr. 4000", "", "", Color.BLUE, Color.BLACK);
        ...
        guiFields[12] = new GUI_Street("Squash", "", "kr. 3.000", "", Color.RED, Color.BLACK);
        ...
        guiFields[25] = new GUI_Street("Mols-Linien", "kr. 4000", "", "", Color.BLUE, Color.BLACK);
        ...
        guiFields[28] = new GUI_Street("Coca Cola","","","",Color.RED,Color.WHITE);
        ...
        guiFields[35] = new GUI_Street("Skandinavisk Linietrafik","kr. 4.000 ","","",Color.BLUE,Color.BLACK);
