...
public class GameBoard
{
    ...
    private void createGuiFields()
    {
        ...
        guiFields[5] = new GUI_Shipping(IMAGE_DIR_PATH+"boat.png","Rederiet Lindinger", "kr. 4000", "", "", Color.BLUE, Color.BLACK);
        ...
        guiFields[20] = new GUI_Shipping(IMAGE_DIR_PATH+"freepark.png","Gratis", "Parkering", "Gratis Parkering", "", Color.WHITE, Color.BLACK);
        ...
        guiFields[35] = new GUI_Shipping(IMAGE_DIR_PATH+"boat.png","Skandinavisk Linietrafik","kr. 4.000 ","","",Color.BLUE,Color.BLACK);
